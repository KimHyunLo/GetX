...
import 'package:getx_tutorial/product_module/controllers/product_controller.dart';

class ProductiveListView extends StatelessWidget {
  final ProductController productController = Get.put(ProductController());

  ProductiveListView({super.key});
